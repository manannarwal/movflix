...
const Mov_Player = () => {
  ...
  return (
    <div>
      <div className="absolute ml-4 pb-21 bg-[#121212] mr-13 rounded-2xl font-sans max-md:-ml-9.5 max-md:w-[93.5vw] max-md:pr-10  max-md:h-[89vh]">
      ...
      {/* Video Player */}
      <iframe
        className="rounded-2xl mt-2 mx-1 max-md:pl-1 "
