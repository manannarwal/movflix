    ...
    <div>
      ...
      <div className="mb-50 relative font-sans font-semibold">
        <div className="relative inline-block">
          <CiSearch className="absolute left-[36vw] top-[1em] size-7 text-gray-400 max-md:size-6"/>
          <input
            className="bg-[#191919] ml-[35vw] mt-2.5 w-[30vw] pl-15 py-2 rounded-3xl ease-in-out duration-200 outline-none focus:bg-[#202020] max-md:pl-7 max-md:w-[45vw] max-md:text-xs"
            type="text"
            value={search}
